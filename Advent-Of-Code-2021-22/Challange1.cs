...
{
    /// <summary>
    /// Main Class for Challange 1 -- Thanks u/Deynai for help!
    /// </summary>
    public static class Challange1
    {
        ...
        {
            //Parse Input Data
            //If out of -50;-50;-50 -> 50;50;50 box, ignore the line
            ...
            foreach (string line in inputData)
            {
                ...
                if (xStart < -50 || xEnd > 50 || yStart < -50 || yEnd > 50 || zStart < -50 || zEnd > 50) continue;
