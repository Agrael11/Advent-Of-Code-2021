...
namespace AdventOfCode.Day8.Puzzle2
{
    /// <summary>
    /// Main Class for Day 8 - Challange 2 of Advent of Code 2021
    /// </summary>
    class Program
    {
        ...
        static void Main()
        {
            ...
            foreach (string input in inputData)
            {
                ...
                List<string> numeralsInfo = input.Split(" | ")[0].Split(' ').ToList();
            ...
            //And as always - write total on screen
